...
Делается с нуля, своими силамы, бес подглядываний, для демонстрации своего codeStyle, применяемых концепций, паттернов и т.п. *( поставил перд собой задачу: написать фреймворк своими силами - это же всегда интересно )*  
